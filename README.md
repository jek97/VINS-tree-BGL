...
# ex for euroc stereo plus imu from VOAgBot
ros2 run vins vins_node ./src/VINS-tree/config/euroc/euroc_stereo_imu_config.yaml
...
### run bag file
```bash
ros2 bag play datasets/euroc/euroc_conv/euroc_conv.db3
```
...
## Original repo from which i took it:
[repo](https://github.com/zinuok/VINS-Fusion-ROS2)