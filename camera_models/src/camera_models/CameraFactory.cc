...
CameraPtr
CameraFactory::generateCameraFromTopic(const sensor_msgs::msg::CameraInfo &camera_info, const std::string camera_name)
{   
    if(camera_info.distortion_model == "plumb_bob")
    {
        ...
        PinholeCamera::Parameters params = camera->getParameters( );
        params.readFromTopic(camera_info, camera_name);
        camera->setParameters( params );
        return camera;
    }
    else
    {
        Camera::ModelType modelType = Camera::PINHOLE_FULL;
