...
bool
PinholeFullCamera::Parameters::readFromTopic(const sensor_msgs::msg::CameraInfo &camera_info, const std::string camera_name)
{
    m_modelType = PINHOLE_FULL;
    m_cameraName = camera_name;
    m_imageWidth  = static_cast< int >( camera_info.width );
    m_imageHeight = static_cast< int >( camera_info.height );

    m_k1           = static_cast< double >( camera_info.d[0] );
    m_k2           = static_cast< double >( camera_info.d[1] );
    m_k3           = static_cast< double >( camera_info.d[4] );
    m_k4           = static_cast< double >( camera_info.d[5] );
    m_k5           = static_cast< double >( camera_info.d[6] );
    m_k6           = static_cast< double >( camera_info.d[7] );
    m_p1           = static_cast< double >( camera_info.d[2] );
    m_p2           = static_cast< double >( camera_info.d[3] );

    m_fx = static_cast< double >( camera_info.k[0] );
    m_fy = static_cast< double >( camera_info.k[4] );
    m_cx = static_cast< double >( camera_info.k[2] );
    m_cy = static_cast< double >( camera_info.k[5] );
